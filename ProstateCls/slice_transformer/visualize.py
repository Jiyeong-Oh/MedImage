"""
Visualization for PI-CAI classification results — channel adapter variant.
Usage:
...
def main(args):
    ...
    fig.suptitle(f'Job {job_id} — Slice Transformer (backbone 1e-5 / adapter+head 3e-4)', fontsize=13)
